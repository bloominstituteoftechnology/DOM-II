...
navmain[0].addEventListener("mouseover", () => {
  navmain[0].style.color = "yellow";
  });

navmain[0].addEventListener("mouseout", () => {
  navmain[0].style.color = "green";
});
...
ctalogo.addEventListener("click", () => {
