...
* [C ] Navigate to the root of the project with your command line.
* [C ] Run `npm install` to download any dependencies listed in the `package.json` file.
* [C ] Run `npm start` to compile your project and launch a development server.
* [C ] Navigate Chrome to the URL indicated in the output of the `npm start` command.
