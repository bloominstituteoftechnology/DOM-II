...
navItems.forEach((link) => link.addEventListener('click', (event) => {event.target.style.backgroundColor = 'orange';
event.stopPropagation();}));
header.addEventListener('click', (event) => event.currentTarget.style.backgroundColor = 'green');
