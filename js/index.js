...
//Mouse Enter and Mouse Leave addEventListener
document.querySelectorAll('nav a')[0].textContent = siteContent["nav"]["nav-item-1"];
document.querySelectorAll('nav a')[0].addEventListener("mouseenter", (event) => {
  document.querySelectorAll('nav a')[0].style.background = "blue";
});
document.querySelectorAll('nav a')[0].addEventListener("mouseleave", (event) => {
  document.querySelectorAll('nav a')[0].style.background = "white";
})
...
document.querySelector('button').addEventListener("click", (event) => {
    if(isDom){
      document.querySelector(".cta-text").style.background = "white";
      isDom = false;
    } else {
      document.querySelector(".cta-text").style.background = "green";
      isDom = true;
    }
});
...
document.querySelectorAll("img")[0].addEventListener("dblclick", (event) => {
  alert("congrats you found a secret egg!");
})
