...
document.getElementById("cta-img").addEventListener("mouseover", ()=>{ document.getElementById("cta-img").style.border="5px solid red";});
document.getElementById("cta-img").addEventListener("mouseout", ()=>{ document.getElementById("cta-img").style.border="0px solid red";});
document.getElementById("cta-img").addEventListener("dblclick", ()=>{ document.getElementById("cta-img").style.border="8px solid green";});
document.querySelector("h1").addEventListener("mouseenter", ()=>{ document.querySelector("h1").style.background="blue";});
document.querySelector("h1").addEventListener("mouseleave", ()=>{ document.querySelector("h1").style.background="white";});