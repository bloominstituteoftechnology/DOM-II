...
logoID.src = "img/logo.png";
logoID.alt = "Great Idea! Company logo.";


let ctaH1 = document.querySelector(".cta h1");
ctaH1.innerHTML = "DOM Is Awesome (Scroll or click here)";

let ctaButton = document.querySelector(".cta button");
ctaButton.innerHTML = "double click here";

let ctaImageId = document.querySelector("#cta-img");
ctaImageId.src = "img/header-img.png";
ctaImageId.alt = "Image of a code snippet."

// let featuresH4 = document.querySelector("siteContent[main-content][features-h4]");
let featuresH4 = document.querySelector("features-h4");
featuresH4.innerHTML= "Features (double-click me)";

// let featuresContent = document.querySelectorAll(".features-content");
// featuresContent.innerHTML = "Features content elementum magna eros, ac posuere elvit tempus et. Suspendisse vel tempus odio, in interdutm nisi. Suspendisse eu ornare nisl. Nullam convallis augue justo, at imperdiet metus scelerisque quis. ******PRESS ANY KEY or CLICK HERE.******";

// let aboutH4 = document.querySelectorAll(".about-h4");
// aboutH4.innerHTML = "About (double-click me)";

// let aboutContent = document.querySelectorAll(".about-content");
// aboutContent.innerHTML = "About content elementum magna eros, ac posuere elvit tempus et. Suspendisse vel tempus odio, in interdutm nisi. Suspendisse eu ornare nisl. Nullam convallis augue justo, at imperdiet metus scelerisque quis. ******PRESS ANY KEY or CLICK HERE.******";
